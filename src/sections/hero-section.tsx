...
export default function HeroSection() {
    ...
    return (
        <main className="flex flex-col items-center pt-32 max-md:px-4 text-center">
            ...
            {/* নাম (পছন্দের mt-5 স্পেসিং ফিরিয়ে আনা হয়েছে) */}
            <h2 className="text-3xl md:text-5xl font-semibold mt-5 text-gray-900 leading-tight">
                Arnob Biswas
            </h2>

            {/* টাইপরাইটার সেকশন - এনায়েত চৌধুরীর মতো স্থির পজিশন */}
            <div className="mt-1.5 flex justify-center w-full">
                {/* এই বক্সটির উইডথ (w) ফিক্সড করা হয়েছে যাতে লেখা লাফালাফি না করে */}
            ...
            {/* বাটন সেকশন (পছন্দের mt-8 স্পেসিং ফিরিয়ে আনা হয়েছে) */}
