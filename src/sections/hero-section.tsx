...
export default function HeroSection() {
    return (
        <main className="flex flex-col items-center pt-32 max-md:px-4">
            {/* এখানে থাকা আগের SVG ব্লকটি সরিয়ে ফেলা হয়েছে */}

            <img
                src="/assets/user-image.png" // এখানে আপনার ছবির পাথ দিবেন
                alt="Profile Image"
            ...
            <p className="text-2xl md:text-3xl font-mono mt-4 text-gray-600">
                Content Creator
            </p>
            ...
            <div className="space-x-6 mt-12 flex items-center">
                <a href="#" className="inline-flex hover:-translate-y-1 transition text-gray-600 hover:text-black">
