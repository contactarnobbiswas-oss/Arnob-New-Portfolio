...
export default function HeroSection() {
    ...
    // টাইপরাইটার লজিক যা পজিশন ঠিক রাখবে
    useEffect(() => {
        if (subIndex === identities[index].length + 1 && !reverse) {
            setTimeout(() => setReverse(true), 1500); // লেখা শেষ হলে ১.৫ সেকেন্ড থামবে
            return;
        }
    ...
    return (
        <main className="flex flex-col items-center pt-32 max-md:px-4 text-center">
            {/* প্রোফাইল পিকচার (শ্যাডো এবং বর্ডার সহ) */}
            <img
            ...
            {/* নাম (সাইজ কমিয়ে মাঝারি করা হয়েছে) */}
            <h2 className="text-3xl md:text-5xl font-semibold mt-5 text-gray-900 leading-tight">
                Arnob Biswas
            </h2>

            {/* টাইপরাইটার সেকশন (Fixed Height h-12 দিয়ে জাম্পিং সমস্যা সমাধান করা হয়েছে) */}
            <div className="h-12 flex items-center justify-center mt-1 w-full overflow-hidden">
                <p className="text-2xl md:text-3xl font-mono text-gray-600">
