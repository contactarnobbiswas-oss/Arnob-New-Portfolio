...
export default function HeroSection() {
    ...
    return (
        <main className="flex flex-col items-center pt-32 max-md:px-4 text-center">
            ...
            {/* নাম (আপনার পছন্দের mt-5 স্পেসিং ফিরিয়ে আনা হয়েছে) */}
            <h2 className="text-3xl md:text-5xl font-semibold mt-5 text-gray-900 leading-tight">
                Arnob Biswas
            </h2>

            {/* টাইপরাইটার (mt-1.5 স্পেসিং এবং Ghost Text দিয়ে পজিশন লক করা) */}
            <div className="relative h-12 flex items-center justify-center mt-1.5 w-full">
                {/* ইনভিজিবল ঘোস্ট টেক্সট - এটি জায়গাটুকু স্থির রাখবে */}
                <p className="text-2xl md:text-3xl font-mono invisible pointer-events-none">
                    Visual Storyteller
                </p>
                {/* আসল টাইপিং টেক্সট */}
            ...
            {/* বাটন সেকশন (আপনার পছন্দের mt-8 স্পেসিং ফিরিয়ে আনা হয়েছে) */}
